...
function getPermissions() {
  if (!RNPermissions) {
    try {
      RNPermissions = __require("react-native-permissions");
    } catch {
    }
  }
...
var AudioCaptureManager = class extends TypedEventEmitter {
  ...
  async requestPermission() {
    ...
    try {
      ...
      const permission = Platform2.OS === "ios" ? permissions.PERMISSIONS.IOS.MICROPHONE : permissions.PERMISSIONS.ANDROID.RECORD_AUDIO;
...
function useVoiceChat(config, options) {
  ...
  const [subtitle, setSubtitle] = react.useState("Tap to start");
...
function FloatingButton({ theme, isExpanded, onPress, position }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    reactNative.TouchableOpacity,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles.iconContainer, children: [
        /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles.headphoneArc, { borderColor: "#fff" }] }),
        /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles.earPieceRow, children: [
          /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles.earPiece, { backgroundColor: "#fff" }] }),
          /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles.earPiece, { backgroundColor: "#fff" }] })
        ] })
      ] })
    }
...
function StatusIndicator({ connectionState, subtitle, theme }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles2.container, children: [
    /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles2.dot, { backgroundColor: dotColor }] }),
    /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: styles2.text, children: subtitle })
  ] });
}
...
function ChatHeader({ theme, connectionState, subtitle, onClose }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: [styles3.container, { backgroundColor: theme.headerGradientStart }], children: [
    /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles3.avatar, { backgroundColor: "rgba(255,255,255,0.2)" }], children: /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles3.avatarIconContainer, children: [
      /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles3.headphoneArc, { borderColor: "#fff" }] }),
      /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles3.earPieceRow, children: [
        /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles3.earPiece, { backgroundColor: "#fff" }] }),
        /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles3.earPiece, { backgroundColor: "#fff" }] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles3.info, children: [
      /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: styles3.title, children: "AI Assistant" }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(reactNative.TouchableOpacity, { onPress: onClose, style: styles3.closeButton, hitSlop: { top: 8, bottom: 8, left: 8, right: 8 }, children: /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles3.closeIcon, children: [
      /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles3.closeLine, styles3.closeLineA] }),
      /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles3.closeLine, styles3.closeLineB] })
    ] }) })
  ] });
}
...
function MessageBubble({ message, theme }) {
  if (message.type === "thinking") {
    return /* @__PURE__ */ jsxRuntime.jsx(ThinkingIndicator, { theme });
  }
  if (message.type === "system") {
    return /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: styles4.systemContainer, children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: [styles4.systemText, { color: theme.systemMessageColor }], children: message.text }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    reactNative.View,
    {
      ...
      children: [
        !isUser && /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles4.avatar, { backgroundColor: theme.primaryColor }], children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: styles4.avatarText, children: "AI" }) }),
        /* @__PURE__ */ jsxRuntime.jsx(
          reactNative.View,
          {
            style: [
...
function ThinkingIndicator({ theme }) {
  const dot1 = react.useRef(new reactNative.Animated.Value(0.3)).current;
  const dot2 = react.useRef(new reactNative.Animated.Value(0.3)).current;
  const dot3 = react.useRef(new reactNative.Animated.Value(0.3)).current;
  react.useEffect(() => {
    const animate = (dot, delay) => reactNative.Animated.loop(
      reactNative.Animated.sequence([
        reactNative.Animated.delay(delay),
        reactNative.Animated.timing(dot, {
          toValue: 1,
          duration: 300,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles4.assistantRow, children: [
    /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles4.avatar, { backgroundColor: theme.primaryColor }], children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: styles4.avatarText, children: "AI" }) }),
    /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles4.bubble, styles4.assistantBubble, { backgroundColor: theme.assistantBubbleColor }], children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: styles4.dotsRow, children: [dot1, dot2, dot3].map((dot, i) => /* @__PURE__ */ jsxRuntime.jsx(
...
function MessageList({ messages, theme }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    reactNative.FlatList,
    {
      ...
      renderItem: ({ item }) => /* @__PURE__ */ jsxRuntime.jsx(MessageBubble, { message: item, theme }),
      style: styles5.list,
...
function MicButton({ theme, isStreaming, isConnected, onPress }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles6.wrapper, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      reactNative.TouchableOpacity,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles6.iconContainer, children: [
          /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles6.micBody, { backgroundColor: "#fff" }] }),
          /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles6.micBase, { borderColor: "#fff" }] })
        ] })
      }
    )
  ] });
...
function InputBar({ theme, isStreaming, isConnected, onSendText, onMicToggle }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles7.container, children: [
    ...
    text.trim().length > 0 ? /* @__PURE__ */ jsxRuntime.jsx(
      reactNative.TouchableOpacity,
      {
        onPress: handleSend,
        style: [styles7.sendButton, { backgroundColor: theme.primaryColor }],
        activeOpacity: 0.7,
        children: /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles7.arrowUp, children: [
          /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles7.arrowLine, { backgroundColor: "#fff" }] }),
          /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles7.arrowHead, { borderBottomColor: "#fff" }] })
        ] })
      }
    ) : /* @__PURE__ */ jsxRuntime.jsx(
      MicButton,
...
function PoweredByFooter() {
  return /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: styles8.container, children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: styles8.text, children: "Powered by smartserve.ai" }) });
}
...
var { width: screenWidth, height: screenHeight } = reactNative.Dimensions.get("window");
function ChatPanel({
  theme,
  messages,
  connectionState,
...
function VoiceChatWidget({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles10.container, pointerEvents: "box-none", children: [
    voiceChat.isExpanded && /* @__PURE__ */ jsxRuntime.jsx(reactNative.TouchableWithoutFeedback, { onPress: voiceChat.toggleExpanded, children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: styles10.overlay }) }),
    voiceChat.isExpanded && /* @__PURE__ */ jsxRuntime.jsx(
      ChatPanel,
      {
        theme,
